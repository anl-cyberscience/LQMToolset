...
LQMT supports Splunk using Splunk's [REST Api](http://dev.splunk.com/restapi). 
...
`source`                | Name of the source you want the data to be identified by.
`sourcetype`            | The sourcetype that you want to insert the data into

#### Device Setup and Configuration 
LQMT authenticates using Splunk's token-based authentication endpoint. This requires you to provide a username and password.
It is recommended that you create a new user specifically for your LQMT instance for security and auditing purposes. 
