...
class ToSnort(Tool):
    ...
    def process(self, alerts):
        ...
        # at this time only handles a STIX object, long term support other types
        if type(alerts).__name__ != 'StixFile':
