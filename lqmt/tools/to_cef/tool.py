...
class Header():
    ...
    def toCEFString(self):
        ...
        s+=" CEF:{0}|{1}|{2}|{3}|{4}|{5}|{6}".format(self._version,self._escape(self._deviceVendor),self._escape(self._deviceProduct),self._escape(self._deviceVersion),self._escape(self._signatureID),self._escape(self._name),self._severity)
        return s
    def _escape(self,s):
